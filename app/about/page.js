    ...
    <div>
        ...
        <div className="page-narrow">
          <div className="two-col">
            ...
            <div>
              ...
              <p className="t-base" style={{ fontFamily: 'Arial', color: C.text, lineHeight: 1.8, marginBottom: 20, textWrap: 'pretty' }}>
              ...
              <p className="t-base" style={{ fontFamily: 'Arial', color: C.text, lineHeight: 1.8, textWrap: 'pretty' }}>
          ...
          {lessons.map(([num, title, body]) => (
            <div key={num} style={{ display: 'grid', gridTemplateColumns: '48px 1fr', gap: '0 28px', padding: '32px 0', borderTop: `1px solid ${C.border}` }}>
              ...
              <div>
                ...
                <p className="t-sub" style={{ fontFamily: 'Arial', color: C.muted, lineHeight: 1.75, textWrap: 'pretty' }}>{body}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="page-narrow">
          <div className="two-col">
            ...
            <div>
              ...
              <p className="t-base" style={{ fontFamily: 'Arial', color: C.text, lineHeight: 1.8, marginBottom: 18, textWrap: 'pretty' }}>
      ...
      <section className="section-pad" style={{ background: C.bgSubtle }}>
        <div className="page-narrow">
          ...
          <p className="t-base" style={{ fontFamily: 'Arial', color: C.text, lineHeight: 1.8, maxWidth: 640, marginBottom: 44, textWrap: 'pretty' }}>
          ...
          <div className="values-row">
            {lpValues.map(([title, body]) => (
              <div key={title} style={{ flex: 1 }}>
                ...
                <p className="t-sm" style={{ fontFamily: 'Arial', color: C.muted, lineHeight: 1.7, textWrap: 'pretty' }}>{body}</p>
              </div>
            ))}
          </div>
