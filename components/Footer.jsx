      ...
      <div className="page-max">
        <div className="footer-top">
          <div>
            ...
            <p style={{ fontFamily: 'Arial,Helvetica,sans-serif', fontSize: 13, color: 'rgba(250,249,246,0.50)', lineHeight: 1.75, marginBottom: 24, maxWidth: 260 }}>
            ...
            <div key={title}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {items.map(([label, href]) => (
                  <Link key={label} href={href} style={{ fontFamily: 'Arial', fontSize: 13, color: 'rgba(250,249,246,0.60)', textDecoration: 'none' }}>
                    {label}
                  </Link>
                ))}
              </div>
